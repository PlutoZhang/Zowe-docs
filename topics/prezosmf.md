...
4. Other requirements
   ...
   5. Post-configuration verification checklist steps to ensure z/OSMF is ready for Giza.
      ...
      From the lines above, the port number is 443. You need this later.
